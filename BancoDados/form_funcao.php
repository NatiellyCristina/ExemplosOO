<?php
	...
	if(isset($_POST["ID"])){
		...
		$colunas=array("id_funcao", "titulo_funcao", "salario_maximo", "salario_minimo");
		$tabelas[0][0]="funcao";
		$tabelas[0][1]=null;
		$ordenacao=null;
		$condicao = $_POST["ID"];
	...
	$f->add_input($v);
	$v = array("type"=>"number","name"=>"SALARIO_MINIMO","placeholder"=>"SALÁRIO MÍNIMO...", "value"=>$value_salario_maximo);
	$f->add_input($v);
	$v = array("type"=>"number","name"=>"SALARIO_MAXIMO","placeholder"=>"SALÁRIO MÁXIMO...", "value"=>$value_salario_minimo);
	$f->add_input($v);
